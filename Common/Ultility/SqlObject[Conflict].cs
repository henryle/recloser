...
namespace FA_Accounting.Common
{
    ...
    {
        //public static string ConnectionString = "Data Source=(local);Initial Catalog=FAAccTest;User ID=sa;Password=Goodman99sa";
        public static string ConnectionString = "Data Source=(local);Initial Catalog=FAAccounting;User ID=sa;Password=Goodman99sa";
