...
namespace TcpComm
{
    public static class Ultility
    {
        ...
        {
            // string data_w = "0a 0b 0c,0x0d 0xaa,0xbb cc";
            // byte[] aaaaa = ParseSerialRecDat.StringToByteArray(data_w);

            string hex = hex_str.Replace(" ", "").Replace("0x", "").Replace("0X", "").Replace(",", "");//remove space
            if (hex.Length % 2 != 0)
            {
        ...
        {
            // convert a string such as "20:45:10" represent a time to byte to be sent 
