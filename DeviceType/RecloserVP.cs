...
{    
    public class RecloserVP: RecloserBase
    {
        ...
        protected override void SaveData()
        {
                ...
                DBController.Instance.SaveRecloserVP(this);
        ...
        private void GetValue(string s)
        {
            ...
            {
                FA_Accounting.Common.LogService.Logger.Error(string.Format("RecloserVP.GetValue({0}) error", s), ex);
            }
        }
    ...
    "VB_GND_load,VC_GND_load,VA_B_src,VB_C_src,VC_A_src,VA_B_load,VB_C_load,VC_A_load,Operation \r\n";
                ...
                {
                    FA_Accounting.Common.LogService.WriteError("WriteRow RecloserVP 1", e.Message); 
                }
            }
            catch (Exception ex)
            {
                FA_Accounting.Common.LogService.WriteError("WriteRow RecloserVP", ex.Message);
            }
        }
        protected override void StartSendingRequests()
        {
            ...
            {
                FA_Accounting.Common.LogService.WriteError("RecloserVP_StartSendingRequest", ex.ToString());
        ...
        public bool sendConnectCommand()
        {
            ...
            {
                FA_Accounting.Common.LogService.WriteError("RecloserVP_sendConnectCommand", ex.ToString());
                return false;
            }
