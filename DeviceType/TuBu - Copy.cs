...
namespace RecloserAcq.Device
{
    public class TuBu : RecloserBase
    {
        ...
        //old code commented out public override void UpdateData1(byte[] data)
        //{ 
        ...
        private void CheckWebEvent()
        {
            // open the file save by web and exec event
        }
        ...
        private bool GetManualOperationTime(byte[] s)
        {
            ...
            if (indexoftime >= 0)
            {
                ...
                {
                    DBController.Instance.SaveTubu(this, (DateTime)this._latestManualCloseTime, this.Status_Open?true:false, null);
                }
                return true;
            }
            return false;
