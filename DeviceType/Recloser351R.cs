...
{    
    public class Recloser351R: RecloserBase
    {
        ...
        protected override void SaveData()
        {
                ...
                {
                    DBController.Instance.SaveRecloser351(this);
                }
        ...
        public double Imag_A
        {
            ...
            set
            {
                ...
                if (value == 0)
                {
                    if (_alertVal == 0)
                    {
                        _alertVal = (int)eAlertVal.Imag_A0;
                        SaveData();
                        Notify("AlertVal");
                    }
                }
                else if( (value > MaxAmp && MaxAmp != 0) || (value < MinAmp && MinAmp!=0) )
                {
                    ...
                    setAlert((int)eAlertVal.Imag_AMax, ref _startZeroA);
                }
                else
                {
                    if (_alertVal == (int)eAlertVal.Imag_A0 || _alertVal == (int)eAlertVal.Imag_AMax )
                    {
        ...
        public double Imag_B
        {
            ...
            set
            {
                ...
                if (value == 0)
                {
                    if (_alertVal == 0)
                    {
                        _alertVal = (int)eAlertVal.Imag_B0;
                        SaveData();
                        Notify("AlertVal");
                    }
                }
                ...
                {
                    setAlert((int)eAlertVal.Imag_BMax, ref _startZeroB);
                }
                else
                {
                    if (_alertVal == (int)eAlertVal.Imag_B0 || _alertVal == (int)eAlertVal.Imag_BMax) 
                    {
                        _alertVal = (int)eAlertVal.None;
                        Notify("AlertVal");
                        _startZeroB = null;
        ...
        public double Imag_C
        {
            ...
            set
            {
                ...
                if (value == 0)
                {
                    if (_alertVal == 0)
                    {
                        _alertVal = (int)eAlertVal.Imag_C0 ;
                        SaveData();
                        Notify("AlertVal");
                    }
                }
                ...
                {
                    setAlert((int)eAlertVal.Imag_CMax, ref _startZeroC);
                }
                else
                {
                    if ( _alertVal == (int)eAlertVal.Imag_C0 || _alertVal == (int)eAlertVal.Imag_CMax) 
                    {
                        _alertVal = (int)eAlertVal.None;
                        Notify("AlertVal");
                        _startZeroC = null;
        ...
        public override eAlertOpenClose CheckCosphi()
        {
            ...
            {
                FA_Accounting.Common.LogService.WriteError("CheckCosphi", ex.Message);
                secondcountminopen = 0;
                secondcountmaxclose = 0;
                tmpDateTimeMin = DateTime.MinValue;
                tmpDateTimeMax = DateTime.MinValue;
        ...
        public eAlertOpenClose CheckQ()
        {
            ...
            {
                FA_Accounting.Common.LogService.WriteError("CheckQ", ex.Message);
                secondcountminopen = 0;
                secondcountmaxclose = 0;
                tmpDateTimeMin = DateTime.MinValue;
                tmpDateTimeMax = DateTime.MinValue;
        ...
        public override void WriteRow()
        {
            ...
            try
            {
                ...
                {
                    FA_Accounting.Common.LogService.WriteError("WriteRow Recloser351 1", e.Message); 
                }
            }
            catch (Exception ex)
            {
                FA_Accounting.Common.LogService.WriteError("WriteRow Recloser351", ex.Message);
            }
        }
        protected override void StartSendingRequests()
        {
            ...
            {
                FA_Accounting.Common.LogService.WriteError("Recloser351R_StartSendingRequest", ex.ToString());
        ...
        public bool sendConnectCommand()
        {
            ...
            {
                FA_Accounting.Common.LogService.WriteError("Recloser351_sendConnectCommand", ex.ToString());
                return false;
            }
        ...
        private readonly byte[] Recloser351_EndBlock1 = new byte[] { 0x3D, 0x3E, 0x3E }; // for value return not for authentication
        private readonly byte[] Recloser351_EndBlock2 = new byte[] { 0x0D, 0x0A, 0x3D };
        private readonly byte[] Recloser351R_Answer_Start1 = new byte[] { 0x44, 0x41, 0x54 }; //DAT
        private readonly byte[] Recloser351R_Answer_Start2 = new byte[] { 0x54, 0x49, 0x4d };//TIM
        private readonly byte[] Recloser351R_Answer_Start3 = new byte[] { 0x53, 0x45, 0x52 };//SER
        private readonly byte[] Recloser351R_Answer_Start4 = new byte[] { 0x4D, 0x45, 0x54 };//MET
        private readonly byte[] Recloser351R_Answer_Start5 = new byte[] { 0x2a, 0x2, 0x2a };//***
        private readonly byte[] Recloser351R_Answer_EndBlock = new byte[] { 0x3D, 0x3E, 0x3E };
        private int GetStartRecloser351R(RingBuffer ringBuffer)
        {
            int start;
